	...
	function academist_elated_admin_scripts_init() {
		...
		if($enable_google_map_in_admin) {
			...
			if ( ! empty( $google_maps_api_key ) ) {
                wp_enqueue_script( 'academist-elated-admin-maps', '//maps.googleapis.com/maps/api/js?key=' . esc_attr( $google_maps_api_key ) . $google_maps_extensions, array(), false, true );
		...
		wp_enqueue_script( 'academist-elated-ui-admin', get_template_directory_uri() . '/framework/admin/assets/js/eltdf-ui/eltdf-ui.js', array(), false, true );
...
if ( ! function_exists( 'academist_elated_enqueue_admin_scripts' ) ) {
	...
	function academist_elated_enqueue_admin_scripts() {
		...
		wp_enqueue_media();
		wp_enqueue_script( 'academist-elated-dependence', get_template_directory_uri() . '/framework/admin/assets/js/eltdf-ui/eltdf-dependence.js', array(), false, true );
		wp_enqueue_script( 'academist-elated-twitter-connect', get_template_directory_uri() . '/framework/admin/assets/js/eltdf-ui/eltdf-twitter-connect.js', array(), false, true );
...
if ( ! function_exists( 'academist_elated_enqueue_meta_box_scripts' ) ) {
	...
	function academist_elated_enqueue_meta_box_scripts() {
		...
		wp_enqueue_media();
        wp_enqueue_script( 'academist-elated-dependence', get_template_directory_uri() . '/framework/admin/assets/js/eltdf-ui/eltdf-dependence.js', array(), false, true );
        wp_enqueue_script( 'academist-elated-repeater', get_template_directory_uri() . '/framework/admin/assets/js/eltdf-ui/eltdf-ui-repeater.js', array(), false, true );
...
if ( ! function_exists( 'academist_elated_enqueue_nav_menu_script' ) ) {
	...
	function academist_elated_enqueue_nav_menu_script( $hook ) {
		if ( $hook == 'nav-menus.php' ) {
			wp_enqueue_script( 'academist-elated-nav-menu', get_template_directory_uri() . '/framework/admin/assets/js/eltdf-ui/eltdf-nav-menu.js' );
			wp_enqueue_style( 'academist-elated-nav-menu', get_template_directory_uri() . '/framework/admin/assets/css/eltdf-nav-menu.css' );
		}
	}
...
if ( ! function_exists( 'academist_elated_enqueue_widgets_admin_script' ) ) {
	...
	function academist_elated_enqueue_widgets_admin_script( $hook ) {
		if ( $hook == 'widgets.php' ) {
			wp_enqueue_script( 'wp-color-picker' );
            wp_enqueue_script( 'academist-elated-dependence', get_template_directory_uri() . '/framework/admin/assets/js/eltdf-ui/eltdf-dependence.js', array(), false, true );
			wp_enqueue_script( 'academist-elated-widgets-dependence', get_template_directory_uri() . '/framework/admin/assets/js/eltdf-ui/eltdf-widget-dependence.js', array(), false, true );
		}
	}
...
if ( ! function_exists( 'academist_elated_meta_box_add' ) ) {
	...
	function academist_elated_meta_box_add() {
		...
		if ( academist_elated_is_wp_gutenberg_installed() || academist_elated_is_gutenberg_installed() ) {
			academist_elated_enqueue_meta_box_styles();
			academist_elated_enqueue_meta_box_scripts();
		} else {
...
if ( ! function_exists( 'academist_elated_tax_add_script' ) ) {
	function academist_elated_tax_add_script() {
		wp_enqueue_media();
		wp_enqueue_script( 'academist-elated-tax-js', ELATED_FRAMEWORK_ROOT . '/admin/assets/js/eltdf-ui/eltdf-tax-custom-fields.js' );
	}
...
if ( ! function_exists( 'academist_elated_user_add_script' ) ) {
	function academist_elated_user_add_script() {
		wp_enqueue_script( 'academist-elated-user-js', ELATED_FRAMEWORK_ROOT . '/admin/assets/js/eltdf-ui/eltdf-user-custom-fields.js' );
	}
