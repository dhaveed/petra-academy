...
if ( ! class_exists( 'AcademistElatedClassSidebar' ) ) {
	class AcademistElatedClassSidebar {
		...
		function load_assets() {
			...
			wp_enqueue_script( 'academist-elated-admin-sidebar-script', ELATED_ROOT . '/framework/admin/assets/js/eltdf-ui/eltdf-sidebar.js' );
			wp_enqueue_style( 'academist-elated-admin-sidebar', ELATED_ROOT . '/framework/admin/assets/css/eltdf-sidebar.css' );
		}
