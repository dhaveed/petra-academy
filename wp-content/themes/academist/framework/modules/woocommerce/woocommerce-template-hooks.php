...
if ( ! function_exists( 'academist_elated_woocommerce_share' ) ) {
	...
	function academist_elated_woocommerce_share() {
        if ( academist_elated_core_plugin_installed() && academist_elated_options()->getOptionValue( 'enable_social_share' ) == 'yes' && academist_elated_options()->getOptionValue( 'enable_social_share_on_product' ) == 'yes' ) :
