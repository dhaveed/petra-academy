					...
					<div class="row">
						<div class="col-lg-12">
							<div class="eltdf-media-uploader">
								...
								<a class="eltdf-media-upload-btn btn btn-sm btn-primary" href="javascript:void(0)" data-frame-title="<?php esc_attr_e( 'Select File', 'academist' ); ?>" data-frame-button-text="<?php esc_attr_e( 'Select File', 'academist' ); ?>"><?php esc_html_e( 'Upload', 'academist' ); ?></a>
