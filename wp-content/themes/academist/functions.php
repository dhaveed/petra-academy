...
if ( ! function_exists( 'academist_elated_enqueue_editor_customizer_styles' ) ) {
    /**
     * Enqueue supplemental block editor styles
     */
    function academist_elated_enqueue_editor_customizer_styles() {
        wp_enqueue_style( 'academist-elated-admin-styles', ELATED_FRAMEWORK_ADMIN_ASSETS_ROOT . '/css/eltdf-modules-admin.css' );
        wp_enqueue_style( 'academist-elated-editor-customizer-styles', ELATED_FRAMEWORK_ADMIN_ASSETS_ROOT . '/css/editor-customizer-style.css' );
    }

    // add google font
    add_action( 'enqueue_block_editor_assets', 'academist_elated_google_fonts_styles' );
    // add action
    add_action( 'enqueue_block_editor_assets', 'academist_elated_enqueue_editor_customizer_styles' );
}
...
if ( ! function_exists( 'academist_elated_get_module_part' ) ) {
    function academist_elated_get_module_part( $module ) {
        return $module;
    }
}

if ( ! function_exists( 'academist_elated_is_gutenberg_installed' ) ) {
	/**
	 * Function that checks if Gutenberg plugin installed
	 * @return bool
	 */
	function academist_elated_is_gutenberg_installed() {
		return function_exists( 'is_gutenberg_page' ) && is_gutenberg_page();
	}
}

if ( ! function_exists( 'academist_elated_is_wp_gutenberg_installed' ) ) {
	/**
	 * Function that checks if WordPress 5.x with Gutenberg editor installed
	 * @return bool
	 */
	function academist_elated_is_wp_gutenberg_installed() {
